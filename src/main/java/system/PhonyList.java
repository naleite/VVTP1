...
public class PhonyList<E> extends AbstractList<E> implements List<E> {
	...
	public boolean contains(Object o) {
		// return indexOf(o) > 0; this is the wrong version
        return indexOf(o) >= 0; // the right version
	}
	...
	public E set(int index, E element) {
		...
		//elementData[++index] = element;//Here why ++index
...
//        if((fromIndex > toIndex) || (toIndex > size) || (fromIndex >= size) || (fromIndex < 0)){
//            throw new IndexOutOfBoundsException(outOfBoundsMsg(toIndex-fromIndex));
//        }
        ...
        //a bug found, can not rise an exception when fromIndex > toIndex
		// clear to let GC do its work
